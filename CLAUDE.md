...
This is a learning project. The agent is being built incrementally by the user, guided step-by-step through concepts rather than having code written for them. Claude's role is to teach and review, not to implement.
